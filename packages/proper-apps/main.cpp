...
private slots:
    ...
    void doRecover(){ auto o=current(); auto steps=o["uninstall_steps"].toArray(); if(!steps.isEmpty()) { runSteps(steps); return; } QMessageBox::information(this,"Recovery","Use Fedora Software or Flatpak to remove this application. Proper Apps stores no credentials."); }
